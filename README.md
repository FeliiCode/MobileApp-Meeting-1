...
void main() {
  ...
  print(menu);
  menu.add('Usus');
  menu.add('Tahu Bacem'); // Nilai Tahu Bacem hanya akan tersimpan sekali karena Set
  print(menu);
  ...
  // Object ini bisa ditimpa berkali-kali nilainya.
  Object data = 'Felissa';
  data = 20;
  data = true;
  ...
  // Di-check dulu tipenya biar tidak error NoSuchMethodError
